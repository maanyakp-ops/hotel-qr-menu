  ...
  const menuTemplates = {
    breakfast: {
      ...
      emoji: "🍳",
      items: [
        { name: "Poha", category: "Breakfast", price: 60, prep_time: 10, description: "Light, fluffy flattened rice with mustard seeds and fresh coriander.", image_url: "https://imgs.search.brave.com/wMGuYw3NV8olpuPUO5030KDHFpSrvnTuRR2JE4w_u0I/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9teWhl/YXJ0YmVldHMuY29t/L3dwLWNvbnRlbnQv/dXBsb2Fkcy8yMDIx/LzA1L3BvaGEtcmVj/aXBlLmpwZw" },
        { name: "Upma", category: "Breakfast", price: 70, prep_time: 10, description: "Savory semolina porridge with vegetables and curry leaves.", image_url: "https://imgs.search.brave.com/w1wat11JQ10TdN_ciBYdno-s-Kfwlr6vmMcuWhDJt-Y/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9jZG4u/Y3JlYXRlLnZpc3Rh/LmNvbS9hcGkvbWVk/aWEvc21hbGwvMTE1/MDU1MDgwL3N0b2Nr/LXBob3RvLXVwbWEt/b3ItdXBhbWEtb3It/dXBwdW1hLWZhdm91/cml0ZS1zb3V0aC1p/bmRpYW4tc3dlZXQt/YW5kLXNhbHR5LWJy/ZWFrZmFzdC1tZW51/LW9yLXNuYWNrcw" },
        { name: "Idli Sambhar", category: "Breakfast", price: 90, prep_time: 10, description: "Steamed rice cakes served with hot sambhar and coconut chutney.", image_url: "https://images.unsplash.com/photo-1584776296944-ab6fb57b0bdd?q=80&w=1458&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
        { name: "Bread Toast", category: "Breakfast", price: 40, prep_time: 5, description: "Crispy toasted bread served with butter and jam.", image_url: "https://images.unsplash.com/photo-1584776296944-ab6fb57b0bdd?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8YnJlYWQlMjB0b2FzdHxlbnwwfHwwfHx8MA%3D%3D" },
        ...
        { name: "Aloo Paratha", category: "Breakfast", price: 80, prep_time: 15, description: "Stuffed whole wheat flatbread with spiced potato filling.", image_url: "https://images.unsplash.com/photo-1683533761804-5fc12be0f684?q=80&w=688&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
    ...
    starters: {
      ...
      items: [
        ...
        { name: "Hara Bhara Kabab", category: "Starters", price: 160, prep_time: 15, description: "Soft spinach and pea patties with a crispy coating.", image_url: "https://plus.unsplash.com/premium_photo-1668618295068-31df85f78d6c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8aGFyYSUyMGJoYXJhJTIwa2FiYWJ8ZW58MHx8MHx8fDA%3D" },
    ...
    maincourse: {
      ...
      emoji: "🍛",
      items: [
        { name: "Dal Makhani", category: "Main Course", price: 180, prep_time: 25, description: "Slow-cooked black lentils in a rich, buttery tomato gravy.", image_url: "https://plus.unsplash.com/premium_photo-1712678664930-ef7051cd1b31?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGRhbCUyMG1ha2huaXxlbnwwfHwwfHx8MA%3D%3D" },
        ...
        { name: "Butter Naan", category: "Main Course", price: 50, prep_time: 10, description: "Leavened bread baked in tandoor, finished with butter.", image_url: "https://images.unsplash.com/photo-1559561724-4ea348cd867f?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
        { name: "Garlic Naan", category: "Main Course", price: 60, prep_time: 10, description: "Tandoor-baked naan topped with roasted garlic and coriander.", image_url: "https://images.unsplash.com/photo-1756821753151-0879e7862e50?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
        ...
        { name: "Roti", category: "Main Course", price: 20, prep_time: 5, description: "Freshly made whole wheat flatbread.", image_url: "https://images.unsplash.com/photo-1718874560784-d4164371eb38?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cm90aXxlbnwwfHwwfHx8MA%3D%3D" },
    ...
    soups: {
      ...
      items: [
        ...
        { name: "Sweet Corn Soup", category: "Soups & Salads", price: 120, prep_time: 10, description: "Thick, comforting sweet corn soup with a hint of pepper.", image_url: "https://images.unsplash.com/photo-1662469863610-0cf8b6e68159?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8c3dlZXQlMjBjb3JuJTIwc291cHxlbnwwfHwwfHx8MA%3D%3D" },
        ...
        { name: "Manchow Soup", category: "Soups & Salads", price: 130, prep_time: 12, description: "Spicy noodle soup topped with crispy fried noodles.", image_url: "https://images.unsplash.com/photo-1672667509988-baade9ade083?q=80&w=1447&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" },
    ...
    beverages: {
      ...
      emoji: "☕",
      items: [
        { name: "Masala Chai", category: "Beverages", price: 40, prep_time: 5, description: "Hot, aromatic tea brewed with ginger and spices.", image_url: "https://images.unsplash.com/photo-1625033405953-f20401c7d848?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8bWFzYWxhJTIwdGVhfGVufDB8fDB8fHww" },
        ...
        { name: "Fresh Orange Juice", category: "Beverages", price: 120, prep_time: 5, description: "Freshly squeezed orange juice, served chilled.", image_url: "https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8b3JhbmdlJTIwanVpY2V8ZW58MHx8MHx8fDA%3D" },
        { name: "Mango Lassi", category: "Beverages", price: 90, prep_time: 5, description: "Thick, creamy yogurt blended with fresh mango pulp.", image_url: "https://images.unsplash.com/photo-1623065422902-30a2d299bbe4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8bWFuZ28lMjBsYXNzaXxlbnwwfHwwfHx8MA%3D%3D" },
        { name: "Buttermilk", category: "Beverages", price: 50, prep_time: 3, description: "Chilled spiced buttermilk with curry leaves and ginger.", image_url: "https://images.unsplash.com/photo-1630409346699-79481a79db52?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YnV0dGVybWlsa3xlbnwwfHwwfHx8MA%3D%3D" },
    ...
    snacks: {
      ...
      items: [
        ...
        { name: "Bread Pakoda", category: "Snacks", price: 60, prep_time: 10, description: "Golden fried bread stuffed with spiced filling.", image_url: "https://media.istockphoto.com/id/1205566657/photo/bread-pakora.webp?a=1&b=1&s=612x612&w=0&k=20&c=ubTiuYpxAMYtiSiMpsoS1x5Z1IkUfeOGELTkOEuJgzw=" },
    ...
    desserts: {
      ...
      emoji: "🍮",
      items: [
        { name: "Gulab Jamun", category: "Desserts", price: 100, prep_time: 5, description: "Soft milk dumplings soaked in rose-scented sugar syrup.", image_url: "https://media.istockphoto.com/id/163064596/photo/gulab-jamun.webp?a=1&b=1&s=612x612&w=0&k=20&c=F_5_AgCdrsecO13W-wiuCZAwYZPBpN3UETTyYtQQlLM=" },
        ...
        { name: "Rasgulla", category: "Desserts", price: 90, prep_time: 5, description: "Soft spongy cottage cheese balls in light sugar syrup.", image_url: "https://media.istockphoto.com/id/1283542929/photo/indian-rasgulla-or-dry-rosogulla-dessert-sweet-served-in-a-bowl.webp?a=1&b=1&s=612x612&w=0&k=20&c=jModAJ68gD3nzjUihAt-2NdZOZ2ilSI8IyUWByAvwV8=" },
        { name: "Kheer", category: "Desserts", price: 110, prep_time: 5, description: "Creamy rice pudding with cardamom and dry fruits.", image_url: "https://media.istockphoto.com/id/1480827583/photo/rice-pudding-served-in-clay-bowl-indian-rice-kheer-with-nuts-on-a-wooden-background-popular.webp?a=1&b=1&s=612x612&w=0&k=20&c=bfzo9QG6cVivIOLBI10Cyxi-MfGTq0E8tQbpEZvglLM=" },
        { name: "Gajar Halwa", category: "Desserts", price: 120, prep_time: 8, description: "Slow-cooked carrot pudding with ghee and nuts.", image_url: "https://media.istockphoto.com/id/877843292/photo/carrot-halwa-or-gajar-ka-halwa.webp?a=1&b=1&s=612x612&w=0&k=20&c=UosG59iA79D-lxUgaiD1GkM2BENmbulRxsHvfliKKGU=" },
